...
const Mountain = () => {
  ...
  useEffect(() => {
    if (inView) {
      animation.start({
        pathLength: [0, 0.1, 0.4, 0.6, 0.8, 1],
  ...
  return (
    <Box pos="absolute" h="100vh" w="100%" overflow="hidden">
      <motion.svg
        ref={ref}
      ...
      >
        <g mask='url("#SvgjsMask1063")' fill="none">
          <motion.path
            ...
            // fill="rgba(71, 24, 126, 1)"
            fill="url(#top)"
          ></motion.path>
          <motion.path
            animate={{ pathLength: 1, opacity: 1, stroke: "#000000" }}
            initial={{ pathLength: 0, opacity: 0, stroke: "#fff" }}
            transition={{ duration: 1, delay: 1.5 }}
        ...
        <defs>
          ...
          <linearGradient x2="0%" y2="100%" gradientUnits="userSpaceOnUse" id="bottom">
            <stop stopColor="#4f1ec1" offset="0"></stop>
            <stop stopColor="rgba(193, 30, 185, 0.0)" offset="1"></stop>
          </linearGradient>
